    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(blank=True, null=True, verbose_name='Часовой пояс')),
                ('myself', models.TextField(verbose_name='О себе')),
                ('hobby', models.TextField(verbose_name='Интересы')),
                ...
                ('city', models.CharField(blank=True, max_length=90, null=True, verbose_name='Город')),
                ('gender', models.CharField(blank=True, choices=[('Мужчина', 'Мужчина'), ('Мужчина', 'Женщина')], max_length=50, null=True, verbose_name='Пол')),
